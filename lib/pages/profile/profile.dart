...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
                      ...
                      children: <Widget>[
                        AnimatedContainer(
                          ...
                          child: RippleButton(
                            child: customImage(
                              context,
                              authstate.profileUser.profilePict,
                              height: 80,
                            ),
                              ...
                              isMyProfile
                                  ...
                                  : RippleButton(
                                      ...
                                      child: Container(
                                        ...
                                        // TwitterIcon(context, icon:AppIcon.messageEmpty, iconColor: TwitterColor.dodgetBlue, paddingIcon: 8)
                                      ),
                                    ),
                              SizedBox(width: 10),
                              RippleButton(
  ...
  isFollower() {
    ...
    if (authState.profileUser.followers != null &&
      ...
      return (authState.profileUser.followers.any((x) =>
      x == authState.userModel.userId));
    } else {
      return false;
    }
  }
            ...
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ...
                      : 'post any Tweet yet'}'
                      : '${authstate.profileUser.userName} hasn\'t ${isreply
                      ? 'reply to any Tweet'
                      : isMedia
                      ? 'post any media Tweet yet'
                      : 'post any Tweet yet'}',
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              TwitterIcon(icon: AppIcon.locationPin,
                  size: 14,
                  paddingIcon: 5,
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              TwitterIcon(icon: AppIcon.calender,
                  size: 14,
                  paddingIcon: 5,
                  iconColor: AppColor.darkGrey),
              SizedBox(width: 10),
