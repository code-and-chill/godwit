...
import 'package:twitter/page/profile/profile.dart';
            ...
            onSelected: (d) {
              switch (d.title) {
                case "Share image link":
                  share(authstate.profileUserModel.profilePict);
                  break;
                case "Open in browser":
                  launchURL(authstate.profileUserModel.profilePict);
                  break;
                case "Save":
                  break;
              }
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: customAdvanceNetworkImage(
                  authstate.profileUserModel.profilePict),
              fit: BoxFit.contain,
            ),
          ),
        ),
