...
import 'package:twitter/widgets/image/composeBottomIconWidget.dart';
import 'package:twitter/widgets/image/composeTweetImage.dart';
import 'package:twitter/widgets/label/customUrlText.dart';
import 'package:twitter/widgets/label/title_text.dart';
import 'package:twitter/widgets/layout/widgetView.dart';
import 'package:twitter/widgets/navigation/customAppBar.dart';
...
class _UserList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return !Provider
        .of<Tweet>(context)
        .displayUserList || list == null || list.length < 0 || list.length == 0
        ? SizedBox.shrink()
        : Container(
            ...
            user: list[index],
                  onUserSelected: (user) {
                    textEditingController.text =
                        Provider.of<Tweet>(context).getDescription(
                            user.userName) + " ";
      ...
      title: Row(
        children: <Widget>[
          ConstrainedBox(
            constraints: BoxConstraints(
                minWidth: 0, maxWidth: fullWidth(context) * .5),
            child: TitleText(user.displayName, fontSize: 16,
                fontWeight: FontWeight.w800,
                overflow: TextOverflow.ellipsis),
          ),
          SizedBox(width: 3),
