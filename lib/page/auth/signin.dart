...
class _SignInState extends State<SignIn> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(30.0)), borderSide: BorderSide(color: Colors.blue)),
  ...
  Widget _labelButton(String title, {Function onPressed}) {
    return FlatButton(
      ...
      child: Text(
        title,
        style: TextStyle(color: TwitterColor.dodgetBlue, fontWeight: FontWeight.bold),
      ),
    );
  }
  ...
  void _emailLogin() {
    ...
    var isValid = validateCredentials(_scaffoldKey, _emailController.text, _passwordController.text);
    if (isValid) {
