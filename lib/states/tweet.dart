...
class Tweet extends ChangeNotifier {
  ...
  Future<void> sendNotification(Feed model, SearchState state) async {
    final usernameRegex = r"(@\w*[a-zA-Z1-9])";
    RegExp regExp = new RegExp(usernameRegex);
    var status = regExp.hasMatch(description);
  ...
  Future<void> sendNotificationToUser(Feed model, User user) async {
    ...
    var body = jsonEncode(<String, dynamic>{
      'notification': <String, dynamic>{'body': model.description, 'title': "${model.user.displayName} metioned you in a tweet"},
      'priority': 'high',
      'data': <String, dynamic>{
