...
class TweetBottomSheet {
  Widget tweetOptionIcon(BuildContext context, Feed model, TweetType type) {
    return CustomInkWell(
        ...
        child: Container(
          ...
          child: TwitterIcon(
              icon: AppIcon.arrowDown, iconColor: AppColor.lightGrey),
        ));
  }

  void _openBottomSheet(BuildContext context, TweetType type,
      Feed model) async {
  ...
  Widget _tweetOptions(BuildContext context, bool isMyTweet, Feed model,
      TweetType type) {
    return Column(
      children: <Widget>[
        Container(
  ...
  void openRetweetBottomSheet(BuildContext context, TweetType type,
      Feed model) async {
    await showModalBottomSheet(
      backgroundColor: Colors.transparent,
      context: context,
