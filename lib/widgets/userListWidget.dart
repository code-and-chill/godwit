...
class UserTile extends StatelessWidget {
  ...
  bool isFollowing() {
    if (user.followersList != null && user.followersList.any((x) => x == myId)) {
      return true;
    } else {
      return false;
    }
        ...
        children: <Widget>[
          ListTile(
            ...
            title: Row(
              children: <Widget>[
                ConstrainedBox(
                  constraints: BoxConstraints(minWidth: 0, maxWidth: fullWidth(context) * .4),
            ...
            trailing: RippleButton(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isFollow ? TwitterColor.dodgetBlue : TwitterColor.white,
