...
class TweetBottomSheet {
  Widget tweetOptionIcon(BuildContext context, Feed model, TweetType type) {
  ...
  void _openbottomSheet(BuildContext context, TweetType type, Feed model) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
            ...
            child: type == TweetType.Tweet ? _tweetOptions(context, isMyTweet, model, type) : _tweetDetailOptions(context, isMyTweet, model, type));
      },
    );
  }

  Widget _tweetDetailOptions(BuildContext context, bool isMyTweet, Feed model, TweetType type) {
    return Column(
      children: <Widget>[
        Container(
  ...
  Widget _tweetOptions(BuildContext context, bool isMyTweet, Feed model, TweetType type) {
    return Column(
      children: <Widget>[
        Container(
          width: fullWidth(context) * .1,
  ...
  Widget _widgetBottomSheetRow(BuildContext context, int icon, {String text, Function onPressed, bool isEnable = false}) {
    return Expanded(
      child: customInkWell(
        context: context,
        onPressed: () {
  ...
  void openRetweetbottomSheet(BuildContext context, TweetType type, Feed model) async {
    await showModalBottomSheet(
      backgroundColor: Colors.transparent,
      context: context,
      builder: (context) {
  ...
  Widget _retweet(BuildContext context, Feed model, TweetType type) {
    return Column(
      children: <Widget>[
        Container(
          width: fullWidth(context) * .1,
